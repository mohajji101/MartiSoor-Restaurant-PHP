        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-12">
            <div class="col-span-1 md:col-span-1">
                ...
                <p class="text-sm leading-relaxed">
                    Experience the best gourmet dining in town. Fresh ingredients, expert chefs, and a passion for
                    flavor.
                </p>
            </div>
            ...
            <div>
                ...
                <div class="flex">
                    <input type="email" placeholder="Your email"
                        class="bg-slate-800 border-none rounded-l-lg px-4 py-2 w-full focus:ring-1 focus:ring-orange-500 text-white">
