                    ...
                    <div class="divide-y divide-slate-50">
                        ...
                        <div class="p-8 flex items-center gap-6">
                            <div class="w-16 h-16 bg-slate-50 rounded-xl overflow-hidden flex-shrink-0">
                                <img src="<?php echo htmlspecialchars($item['image']); ?>" class="w-full h-full object-cover" alt="">
                            </div>
                            <div class="flex-1">
                                <h4 class="font-bold text-slate-900"><?php echo htmlspecialchars($item['title']); ?></h4>
                                <p class="text-sm text-slate-500">Quantity: <?php echo $item['quantity']; ?></p>
                            </div>
                            <div class="text-right">
                                <span class="font-bold text-slate-900">$<?php echo number_format($item['line_total'], 2); ?></span>
                            </div>
                        </div>
                        <?php endforeach; ?>
                    </div>
            ...
            <div class="lg:col-span-1 space-y-6">
                ...
                <div class="bg-white rounded-[2rem] shadow-xl border border-slate-100 p-8">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="pt-4 border-t border-slate-50 flex justify-between items-center text-slate-900">
                            ...
                            <span class="font-black text-2xl text-orange-600">$<?php echo number_format($order['total'], 2); ?></span>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-slate-900 rounded-[2rem] shadow-xl p-8 text-white relative overflow-hidden">
                    <div class="relative z-10">
                        ...
                        <p class="text-slate-400 text-sm mb-2">Method: <span class="text-white font-medium">Cash on Delivery</span></p>
                        <p class="text-slate-400 text-sm italic">Payment will be collected at the door.</p>
                    </div>
                    <i class="fas fa-truck absolute -bottom-4 -right-4 text-slate-800 text-8xl opacity-30 transform -rotate-12"></i>
                </div>
            </div>
        </div>
    </div>
